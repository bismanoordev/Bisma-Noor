      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <div className="flex flex-col gap-10">
            {timeline.map((item, i) => (
              <div key={item.degree} className="relative flex gap-8">
                {/* Dot */}
                ...
                <div className="flex-1 glow-card rounded-2xl p-6 group">
                  <div className="flex flex-wrap items-start justify-between gap-3 mb-3">
                    <div>
                      ...
                      <h3 className="text-lg sm:text-xl font-display font-bold text-white mt-0.5 group-hover:text-[var(--accent)] transition-colors duration-200">
                        {item.degree}
                      </h3>
