      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {techStack.map((t) => (
                  <span
                    key={t}
                    className="px-3 py-1 rounded-full text-xs font-medium border border-[rgba(34,211,238,0.2)] bg-[rgba(34,211,238,0.05)] text-[var(--accent)] hover:border-[rgba(34,211,238,0.5)] hover:bg-[rgba(34,211,238,0.1)] transition-all cursor-default"
                  >
                    {t}
                  </span>
                ))}
        ...
        <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-4">
          {stats.map(({ value, label }) => (
            <div key={label} className="glow-card rounded-2xl p-6 text-center">
