...
export default function Service() {
  return (
    <div>
      ...
      <div
        id="portfolio"
        className="grid grid-cols-1 md:grid-cols-3 gap-8 min-h-screen text-white px-6 md:px-20 pb-12 pt-12 place-items-start"
      >
        {/* Card 1 */}
        <div
          className="w-full border border-cyan-300/25 rounded-xl shadow-sm
                      transition duration-300 transform hover:-translate-y-2 bg-slate-900/60 backdrop-blur-md"
        >
          <div className="group flex flex-col h-96 items-center pb-10 bg-transparent cursor-pointer rounded-xl transition duration-300 hover:shadow-[0_0_24px_rgba(34,211,238,0.22)] overflow-hidden">
            <img
              src={MovieBox}
              alt="Movie Box"
              className=" object-contain rounded-t-lg"
            />
            <h5 className="mb-2 mt-2 text-4xl text-center font-bold text-gray-100 group-hover:text-gray-400 transition duration-300">
              Movie Box
            </h5>
            <p className="mb-1 text-xl text-center text-gray-100 group-hover:text-gray-400 transition duration-300 px-3">
        ...
        >
          <div className="group flex flex-col h-96 items-center pb-10 bg-transparent cursor-pointer rounded-xl transition duration-300 hover:shadow-[0_0_24px_rgba(34,211,238,0.22)] overflow-hidden">
            <img
              ...
              className=" object-contain rounded-t-lg"
            />
            <h5 className="mb-1 text-4xl text-center font-bold text-gray-100 group-hover:text-gray-400 transition duration-300">
              Bite Into Happiness!
            </h5>
            <p className="mb-2 mt-2 text-xl text-center text-gray-100 group-hover:text-gray-400 transition duration-300 px-3">
