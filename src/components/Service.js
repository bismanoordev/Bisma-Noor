...
export default function Service() {
  return (
    <div>
      ...
      <div
        id="service"
        className="flex flex-col md:flex-row items-center justify-between min-h-screen text-white px-6 md:px-20 py-14"
      >
        {/* Card 1 */}
        <div
          className="w-full max-w-sm border rounded-xl shadow-sm mt-12 mx-4 my-8 
                      transition duration-300 transform hover:-translate-y-2"
        >
          <div className="group flex flex-col h-96 items-center pb-10 pt-10 bg-slate-900/60 backdrop-blur-md cursor-pointer rounded-xl transition duration-300 border border-cyan-300/20 hover:border-cyan-300/50 hover:shadow-[0_0_24px_rgba(34,211,238,0.2)]">
            <FaLaptop className="h-20 w-20 text-gray-100 font-bold mb-5 group-hover:text-cyan-300 transition duration-300" />
        ...
        <div
          className="w-full max-w-sm border rounded-xl shadow-sm mt-12 mx-4 my-8
                      transition duration-300 transform hover:-translate-y-2"
        >
          <div className="group flex flex-col cursor-pointer h-96 items-center pb-10 pt-10 bg-slate-900/60 backdrop-blur-md rounded-xl transition duration-300 border border-cyan-300/20 hover:border-cyan-300/50 hover:shadow-[0_0_24px_rgba(34,211,238,0.2)]">
            <FaCode className="h-20 w-20 text-gray-100 font-bold mb-5 group-hover:text-cyan-300 transition duration-300" />
            <h5 className="mb-1 text-3xl text-center font-bold text-gray-100 group-hover:text-gray-400 transition duration-300">
              Web Application
            </h5>
            <p className="text-sm text-center mt-4 text-gray-100 group-hover:text-gray-400 transition duration-300">
